...
#endif
vec2 l9_0=vec2(Interpolator0.x,Interpolator0.y);
vec4 l9_1;
#if (baseTexLayout==2)
{
...
#endif
vec3 l9_27=mix(l9_25.xyz,definedBlend(l9_25.xyz,l9_2.xyz).xyz,vec3(Port_Value2_N001));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_29=vec4(mix(vec3(1.0),l9_2.xyz,vec3(Port_Value2_N001)),Port_Value2_N001);
}
#else
{
vec4 l9_30;
