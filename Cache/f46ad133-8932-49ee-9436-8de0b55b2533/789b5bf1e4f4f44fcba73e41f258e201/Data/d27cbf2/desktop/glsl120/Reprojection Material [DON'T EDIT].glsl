...
uniform mat4 realModelMatrix;
uniform mat4 uv2Matrix;
uniform float Port_Value2_N005;
uniform float Port_RangeMinA_N011;
uniform float Port_RangeMaxA_N011;
uniform float Port_RangeMaxB_N011;
uniform float Port_RangeMinB_N011;
uniform int overrideTimeEnabled;
uniform float overrideTimeElapsed;
uniform vec4 sc_Time;
uniform float overrideTimeDelta;
uniform mat4 sc_ModelMatrixInverse;
uniform float Port_RangeMinA_N003;
uniform float Port_RangeMaxA_N003;
uniform float Port_RangeMaxB_N003;
uniform float Port_RangeMinB_N003;
...
varColor=color;
vec3 l9_30=normalize((sc_ModelMatrixInverse*vec4(varNormal,0.0)).xyz);
vec4 l9_31=sc_ModelMatrixInverse*vec4(varPos,1.0);
vec2 l9_32=l9_28-vec2(Port_RangeMinA_N003);
vec4 l9_33=sc_ViewProjectionMatrixInverseArray[sc_GetStereoViewIndex()]*vec4(((l9_32/vec2(Port_RangeMaxA_N003-Port_RangeMinA_N003))*(Port_RangeMaxB_N003-Port_RangeMinB_N003))+vec2(Port_RangeMinB_N003),0.0,1.0);
vec4 l9_34=vec4(l9_30.x,l9_30.y,l9_30.z,vec4(0.0).w);
l9_34.w=Port_Value2_N019;
vec4 l9_35=realModelMatrix*l9_34;
float l9_36=dot(l9_35,l9_35);
float l9_37;
if (l9_36>0.0)
{
...
vec4 l9_38=l9_35*l9_37;
vec4 l9_39=sc_ViewProjectionMatrixInverseArray[sc_GetStereoViewIndex()]*vec4(l9_38.xyz,1.0);
vec3 l9_40;
vec3 l9_41;
vec3 l9_42;
if (l9_27)
...
{
l9_42=varTangent.xyz;
l9_41=l9_39.xyz/vec3(l9_39.w);
l9_40=l9_33.xyz/vec3(l9_33.w);
}
varPos=l9_40;
...
{
float l9_56=dot(l9_53,sc_StereoClipPlanes[sc_StereoViewID]);
#if (sc_StereoRendering_IsClipDistanceEnabled==1)
{
sc_SetClipDistancePlatform(l9_56);
}
#else
{
varClipDistance=l9_56;
}
#endif
}
#endif
gl_Position=l9_53;
vec4 l9_58=vec4(l9_31.x,l9_31.y,l9_31.z,vec4(0.0).w);
l9_58.w=Port_Value2_N005;
vec4 l9_59=uv2Matrix*(realModelMatrix*l9_58);
vec2 l9_60=((((vec2(l9_59.xy)/vec2(l9_59.w))-vec2(Port_RangeMinA_N011))/vec2(Port_RangeMaxA_N011-Port_RangeMinA_N011))*(Port_RangeMaxB_N011-Port_RangeMinB_N011))+vec2(Port_RangeMinB_N011);
Interpolator0.x=l9_60.x;
Interpolator0.y=l9_60.y;
}
...
#endif
vec4 l9_1=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,l9_0,vec2(Interpolator0.x,Interpolator0.y),(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex);
vec4 l9_2=vec4(l9_1.x,l9_1.y,l9_1.z,vec4(0.0).w);
l9_2.w=Port_Value2_N001;
...
{
l9_5=clamp(Port_Value2_N001*2.0,0.0,1.0);
}
#else
{
float l9_6;
...
{
l9_6=clamp(dot(l9_2.xyz,vec3(Port_Value2_N001)),0.0,1.0);
}
#else
{
float l9_7;
...
{
l9_8=(1.0-dot(l9_2.xyz,vec3(0.33333001)))*Port_Value2_N001;
}
#else
{
float l9_9;
...
{
l9_9=(1.0-clamp(dot(l9_2.xyz,vec3(1.0)),0.0,1.0))*Port_Value2_N001;
}
#else
{
float l9_10;
...
{
l9_10=clamp(dot(l9_2.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N001;
}
#else
{
float l9_11;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_12=clamp(dot(l9_2.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N001;
}
#else
{
float l9_13;
...
{
l9_13=dot(l9_2.xyz,vec3(0.33333001))*Port_Value2_N001;
}
#else
{
float l9_14;
...
#endif
vec3 l9_26=mix(l9_24.xyz,definedBlend(l9_24.xyz,l9_2.xyz).xyz,vec3(Port_Value2_N001));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_28=vec4(mix(vec3(1.0),l9_2.xyz,vec3(Port_Value2_N001)),Port_Value2_N001);
}
#else
{
vec4 l9_29;
...
{
l9_30=clamp(Port_Value2_N001,0.0,1.0);
}
#else
{
l9_30=Port_Value2_N001;
}
#endif
l9_29=vec4(l9_2.xyz*l9_30,l9_30);
}
#else
{
l9_29=l9_2;
