...
#endif
l9_0=sc_SampleTextureBiasOrLevel(baseTextureDims.xy,baseTextureLayout,l9_1,varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_baseTexture)!=0),baseTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTexture,SC_SOFTWARE_WRAP_MODE_V_baseTexture),(int(SC_USE_UV_MIN_MAX_baseTexture)!=0),baseTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTexture)!=0),baseTextureBorderColor,0.0,baseTexture)*baseColor;
}
#else
{
l9_0=baseColor;
...
#endif
vec4 l9_3=sc_SampleTextureBiasOrLevel(maskTexDims.xy,maskTexLayout,l9_2,varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_maskTex)!=0),maskTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_maskTex,SC_SOFTWARE_WRAP_MODE_V_maskTex),(int(SC_USE_UV_MIN_MAX_maskTex)!=0),maskTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_maskTex)!=0),maskTexBorderColor,0.0,maskTex);
float l9_4=l9_3.x;
vec4 l9_5=vec4(l9_0.x,l9_0.y,l9_0.z,vec4(0.0).w);
l9_5.w=l9_4;
