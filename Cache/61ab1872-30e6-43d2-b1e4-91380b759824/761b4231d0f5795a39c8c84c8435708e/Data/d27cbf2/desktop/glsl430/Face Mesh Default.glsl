...
//sampler sampler baseTextureSmpSC 2:22
//sampler sampler intensityTextureSmpSC 2:23
//sampler sampler maskTexSmpSC 2:24
...
//texture texture2D baseTexture 2:3:2:22
//texture texture2D intensityTexture 2:4:2:23
//texture texture2D maskTex 2:5:2:24
...
//texture texture2DArray baseTextureArrSC 2:34:2:22
//texture texture2DArray intensityTextureArrSC 2:35:2:23
//texture texture2DArray maskTexArrSC 2:36:2:24
...
{
l9_3=sc_SampleTextureBiasOrLevel(baseTextureDims.xy,baseTextureLayout,baseTextureGetStereoViewIndex(),l9_0,(int(SC_USE_UV_TRANSFORM_baseTexture)!=0),baseTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTexture,SC_SOFTWARE_WRAP_MODE_V_baseTexture),(int(SC_USE_UV_MIN_MAX_baseTexture)!=0),baseTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTexture)!=0),baseTextureBorderColor,0.0,baseTextureArrSC);
}
#else
{
l9_3=sc_SampleTextureBiasOrLevel(baseTextureDims.xy,baseTextureLayout,baseTextureGetStereoViewIndex(),l9_0,(int(SC_USE_UV_TRANSFORM_baseTexture)!=0),baseTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTexture,SC_SOFTWARE_WRAP_MODE_V_baseTexture),(int(SC_USE_UV_MIN_MAX_baseTexture)!=0),baseTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTexture)!=0),baseTextureBorderColor,0.0,baseTexture);
}
#endif
l9_2=l9_3*baseColor;
}
...
#if (maskTexLayout==2)
{
l9_4=sc_SampleTextureBiasOrLevel(maskTexDims.xy,maskTexLayout,maskTexGetStereoViewIndex(),l9_0,(int(SC_USE_UV_TRANSFORM_maskTex)!=0),maskTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_maskTex,SC_SOFTWARE_WRAP_MODE_V_maskTex),(int(SC_USE_UV_MIN_MAX_maskTex)!=0),maskTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_maskTex)!=0),maskTexBorderColor,0.0,maskTexArrSC);
}
#else
{
l9_4=sc_SampleTextureBiasOrLevel(maskTexDims.xy,maskTexLayout,maskTexGetStereoViewIndex(),l9_0,(int(SC_USE_UV_TRANSFORM_maskTex)!=0),maskTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_maskTex,SC_SOFTWARE_WRAP_MODE_V_maskTex),(int(SC_USE_UV_MIN_MAX_maskTex)!=0),maskTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_maskTex)!=0),maskTexBorderColor,0.0,maskTex);
}
#endif
vec4 l9_5=vec4(l9_2.x,l9_2.y,l9_2.z,vec4(0.0).w);
l9_5.w=l9_4.x;
#if (sc_BlendMode_AlphaTest)
{
if (l9_4.x<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_4.x<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_10=clamp(l9_4.x*2.0,0.0,1.0);
}
#else
{
float l9_11;
...
{
l9_11=clamp(dot(l9_5.xyz,vec3(l9_4.x)),0.0,1.0);
}
#else
{
float l9_12;
...
{
l9_13=(1.0-dot(l9_5.xyz,vec3(0.33333001)))*l9_4.x;
}
#else
{
float l9_14;
...
{
l9_14=(1.0-clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0))*l9_4.x;
}
#else
{
float l9_15;
...
{
l9_15=clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0)*l9_4.x;
}
#else
{
float l9_16;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_17=clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0)*l9_4.x;
}
#else
{
float l9_18;
...
{
l9_18=dot(l9_5.xyz,vec3(0.33333001))*l9_4.x;
}
#else
{
float l9_19;
...
#endif
vec3 l9_32=mix(l9_30.xyz,definedBlend(l9_30.xyz,l9_5.xyz).xyz,vec3(l9_4.x));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_34=vec4(mix(vec3(1.0),l9_5.xyz,vec3(l9_4.x)),l9_4.x);
}
#else
{
vec4 l9_35;
