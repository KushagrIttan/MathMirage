...
//texture texture2DArray baseTexArrSC 2:25:2:16
...
uniform mat4 mat;
uniform vec3 ceneter_pos;
uniform bool use_dynamic;
...
uniform float Port_Value4_N039;
uniform vec3 Port_Input1_N009;
uniform float Port_Value4_N051;
uniform float Port_Multiplier_N029;
uniform float Port_Input1_N033;
uniform float Port_Input1_N061;
uniform float Port_Multiplier_N038;
uniform float Port_Input0_N062;
uniform float Port_Input1_N032;
uniform float Port_Multiplier_N025;
uniform float Port_Input1_N041;
uniform float Port_Input1_N035;
uniform float Port_Value3_N028;
uniform float Port_Value4_N028;
uniform float Port_Input2_N059;
...
vec3 l9_33=mat3(sc_ModelMatrixInverse[0].xyz,sc_ModelMatrixInverse[1].xyz,sc_ModelMatrixInverse[2].xyz)*(l9_31-ceneter_pos);
vec3 l9_34=(sc_ModelMatrixInverse*vec4(l9_31,Port_Value4_N039)).xyz+(l9_33*Port_Input1_N009);
float l9_35=l9_34.x;
float l9_36=l9_34.y;
float l9_37=l9_30*Port_Multiplier_N029;
float l9_38=l9_30*Port_Multiplier_N038;
float l9_39=l9_30*Port_Multiplier_N025;
float l9_40;
if ((float(use_dynamic)*1.0)!=0.0)
{
float l9_41=l9_33.y+Port_Input1_N010;
float l9_42=l9_41*Port_Input1_N014;
float l9_43;
if ((float(l9_42>Port_Input1_N054)*1.0)!=0.0)
{
l9_43=l9_42;
}
else
{
l9_43=l9_41*Port_Input1_N056;
}
float l9_44=abs(l9_43);
float l9_45=clamp((abs((l9_33.x+Port_Input1_N013)*Port_Input1_N043)+l9_44)+0.001,Port_Input1_N021+0.001,Port_Input2_N021+0.001)-0.001;
float l9_46;
if (l9_45<=0.0)
{
l9_46=0.0;
...
{
l9_46=pow(l9_45,Port_Input1_N011);
}
l9_40=l9_46;
}
else
{
l9_40=Port_Input2_N059;
}
vec3 l9_47=vec3(l9_40);
vec3 l9_48;
vec3 l9_49;
vec3 l9_50;
if (l9_27)
...
l9_50=varTangent.xyz;
l9_49=l9_32;
l9_48=mix(l9_31,((mat*vec4(l9_35,l9_36,l9_34.z,Port_Value4_N051))+vec4((sin(l9_37+(l9_35*Port_Input1_N033))+(Port_Input0_N062*cos((l9_36*Port_Input1_N061)+l9_38)))*Port_Input1_N032,sin(l9_39+(l9_36*Port_Input1_N041))*Port_Input1_N035,Port_Value3_N028,0.0)).xyz,l9_47);
}
varPos=l9_48;
...
{
vec4 l9_63=l9_55;
l9_63.z=((log2(max(sc_Camera.clipPlanes.x,1.0+l9_55.w))*(2.0/log2(sc_Camera.clipPlanes.y+1.0)))-1.0)*l9_55.w;
l9_62=l9_63;
}
else
{
...
{
float l9_64=dot(l9_61,sc_StereoClipPlanes[sc_StereoViewID]);
...
#if (baseTexLayout==2)
{
l9_0=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTexArrSC);
}
#else
{
l9_0=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex);
...
{
if (l9_0.w<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_4=clamp(dot(l9_0.xyz,vec3(l9_0.w)),0.0,1.0);
}
#else
{
float l9_5;
...
{
l9_6=(1.0-dot(l9_0.xyz,vec3(0.33333001)))*l9_0.w;
}
#else
{
float l9_7;
...
{
l9_7=(1.0-clamp(dot(l9_0.xyz,vec3(1.0)),0.0,1.0))*l9_0.w;
}
#else
{
float l9_8;
...
{
l9_8=clamp(dot(l9_0.xyz,vec3(1.0)),0.0,1.0)*l9_0.w;
}
#else
{
float l9_9;
#if (sc_BlendMode_Add)
{
l9_9=clamp(dot(l9_0.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_10;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_10=clamp(dot(l9_0.xyz,vec3(1.0)),0.0,1.0)*l9_0.w;
}
#else
{
float l9_11;
...
{
l9_11=dot(l9_0.xyz,vec3(0.33333001))*l9_0.w;
}
#else
{
float l9_12;
#if (sc_BlendMode_Min)
{
l9_12=1.0-clamp(dot(l9_0.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_13;
#if (sc_BlendMode_Max)
{
l9_13=clamp(dot(l9_0.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_13=1.0;
...
#endif
l9_1=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_0.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_2);
}
#else
{
vec4 l9_14;
...
#if (sc_FramebufferFetch)
{
vec4 l9_17=sc_readFragData0_Platform();
vec4 l9_18;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_19=l9_17;
l9_19.x=l9_17.x+_sc_framebufferFetchMarker;
l9_18=l9_19;
}
#else
{
...
{
l9_22=sc_SampleView(sc_ScreenTextureDims.xy,l9_20,sc_ScreenTextureLayout,l9_21,0.0,sc_ScreenTextureArrSC);
}
#else
{
l9_22=sc_SampleView(sc_ScreenTextureDims.xy,l9_20,sc_ScreenTextureLayout,l9_21,0.0,sc_ScreenTexture);
}
#endif
l9_16=l9_22;
}
...
{
vec4 l9_24=l9_16;
l9_24.x=l9_16.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_23=l9_24;
}
#else
{
...
#endif
vec3 l9_25=mix(l9_23.xyz,definedBlend(l9_23.xyz,l9_0.xyz).xyz,vec3(l9_0.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_27=vec4(mix(vec3(1.0),l9_0.xyz,vec3(l9_0.w)),l9_0.w);
}
#else
{
vec4 l9_28;
...
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_37).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_38=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_37).xy);
...
if (l9_55==0)
{
l9_58=texture(sc_OITAlpha0,l9_50);
l9_57=texture(sc_OITDepthLow0,l9_50);
l9_56=texture(sc_OITDepthHigh0,l9_50);
}
else
{
l9_58=vec4(0.0);
...
if (l9_55==1)
{
l9_61=texture(sc_OITAlpha1,l9_50);
l9_60=texture(sc_OITDepthLow1,l9_50);
l9_59=texture(sc_OITDepthHigh1,l9_50);
}
else
{
l9_61=l9_58;
...
vec4 l9_76=texture(sc_OITFilteredDepthBoundsTexture,l9_50);
vec2 l9_77=l9_76.xy;
int l9_78;
#if (sc_SkinBonesCount>0)
{
