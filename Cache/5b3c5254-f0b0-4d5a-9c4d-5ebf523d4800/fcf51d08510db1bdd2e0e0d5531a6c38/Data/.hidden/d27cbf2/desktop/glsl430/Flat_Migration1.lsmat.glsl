...
{
l9_6=sc_SampleTextureBiasOrLevel(opacityTexDims.xy,opacityTexLayout,opacityTexGetStereoViewIndex(),l9_0,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex),(int(SC_USE_UV_MIN_MAX_opacityTex)!=0),opacityTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0),opacityTexBorderColor,0.0,opacityTexArrSC);
}
#else
{
...
{
l9_13=clamp(dot(l9_7.xyz,vec3(l9_5)),0.0,1.0);
}
#else
{
float l9_14;
...
{
l9_15=(1.0-dot(l9_7.xyz,vec3(0.33333001)))*l9_5;
}
#else
{
float l9_16;
...
{
l9_16=(1.0-clamp(dot(l9_7.xyz,vec3(1.0)),0.0,1.0))*l9_5;
}
#else
{
float l9_17;
...
{
l9_17=clamp(dot(l9_7.xyz,vec3(1.0)),0.0,1.0)*l9_5;
}
#else
{
float l9_18;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_19=clamp(dot(l9_7.xyz,vec3(1.0)),0.0,1.0)*l9_5;
}
#else
{
float l9_20;
...
{
l9_20=dot(l9_7.xyz,vec3(0.33333001))*l9_5;
}
#else
{
float l9_21;
...
#endif
vec3 l9_34=mix(l9_32.xyz,definedBlend(l9_32.xyz,l9_7.xyz).xyz,vec3(l9_5));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_36=vec4(mix(vec3(1.0),l9_7.xyz,vec3(l9_5)),l9_5);
}
#else
{
vec4 l9_37;
