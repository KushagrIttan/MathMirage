...
//texture texture2DArray camTexArrSC 2:37:2:22
//texture texture2DArray drivingHairMaskArrSC 2:38:2:23
//texture texture2DArray flowRelativeArrSC 2:39:2:24
//texture texture2DArray flowSelectionArrSC 2:40:2:25
//texture texture2DArray intensityTextureArrSC 2:41:2:26
//texture texture2DArray sc_ScreenTextureArrSC 2:44:2:31
//texture texture2DArray sourceCropTexArrSC 2:45:2:34
//texture texture2DArray sourceGarmentMaskArrSC 2:46:2:35
//texture texture2DArray sourcePartsArrSC 2:47:2:36
//SG_REFLECTION_END
...
uniform sampler2DArray sourcePartsArrSC;
...
{
vec4 l9_0;
#if (sourcePartsLayout==2)
{
l9_0=sc_SampleTextureBiasOrLevel(sourcePartsDims.xy,sourcePartsLayout,sourcePartsGetStereoViewIndex(),coords,(int(SC_USE_UV_TRANSFORM_sourceParts)!=0),sourcePartsTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_sourceParts,SC_SOFTWARE_WRAP_MODE_V_sourceParts),(int(SC_USE_UV_MIN_MAX_sourceParts)!=0),sourcePartsUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_sourceParts)!=0),sourcePartsBorderColor,0.0,sourcePartsArrSC);
}
#else
{
...
#endif
vec2 l9_3=(((vec2(flowHalfPx)+(((((l9_1+((cropCenter-(cropSize*0.5))*(-1.0)))*(vec2(1.0)/cropSize))-vec2(0.0))*((1.0-flowHalfPx)-flowHalfPx))/vec2(1.0)))-vec2(0.5))*vec2(1.0,-1.0))+vec2(0.5);
float l9_4=l9_3.x;
float l9_5=l9_4*0.2;
float l9_6=l9_3.y;
float l9_7=l9_4*0.33333334;
vec4 l9_8=N75_sampleBiLinearRelative(vec2(l9_5,l9_6));
vec2 l9_9=l9_8.xy;
vec4 l9_10=N75_sampleBiLinearRelative(vec2(l9_5+0.2,l9_6));
vec2 l9_11=l9_10.xy;
vec4 l9_12=N75_sampleBiLinearRelative(vec2(l9_5+0.40000001,l9_6));
vec2 l9_13=l9_12.xy;
vec4 l9_14=N75_sampleBiLinearRelative(vec2(l9_5+0.60000002,l9_6));
vec2 l9_15=l9_14.xy;
vec4 l9_16=N75_sampleBiLinearRelative(vec2(l9_5+0.80000001,l9_6));
vec2 l9_17=l9_16.xy;
vec4 l9_18=N75_sampleBiLinearSelection(vec2(l9_7,l9_6));
vec4 l9_19=N75_sampleBiLinearSelection(vec2(l9_7+0.33333334,l9_6));
vec4 l9_20=N75_sampleBiLinearSelection(vec2(l9_7+0.66666669,l9_6));
float l9_21=l9_18.x;
float l9_22=l9_18.y;
float l9_23=l9_19.x;
float l9_24=l9_19.y;
float l9_25=l9_20.x;
float l9_26=max(max(max(max(l9_21,l9_22),l9_23),l9_24),l9_25);
float l9_27=exp(l9_21-l9_26);
float l9_28=exp(l9_22-l9_26);
float l9_29=exp(l9_23-l9_26);
float l9_30=exp(l9_24-l9_26);
float l9_31=exp(l9_25-l9_26);
float l9_32=(((l9_27+l9_28)+l9_29)+l9_30)+l9_31;
vec2 l9_33=((((l9_9*(l9_27/l9_32))+(l9_11*(l9_28/l9_32)))+(l9_13*(l9_29/l9_32)))+(l9_15*(l9_30/l9_32)))+(l9_17*(l9_31/l9_32));
vec2 l9_34=((l9_3*2.0)-vec2(1.0))+l9_33;
vec2 l9_35=(((l9_34*vec2(sx,sy))+vec2(dx,dy))+vec2(1.0))/vec2(2.0);
vec2 l9_36=vec2(l9_35.x,1.0-l9_35.y);
vec4 l9_37;
#if (sourceCropTexLayout==2)
{
l9_37=sc_SampleTextureBiasOrLevel(sourceCropTexDims.xy,sourceCropTexLayout,sourceCropTexGetStereoViewIndex(),l9_36,(int(SC_USE_UV_TRANSFORM_sourceCropTex)!=0),sourceCropTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_sourceCropTex,SC_SOFTWARE_WRAP_MODE_V_sourceCropTex),(int(SC_USE_UV_MIN_MAX_sourceCropTex)!=0),sourceCropTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_sourceCropTex)!=0),sourceCropTexBorderColor,0.0,sourceCropTexArrSC);
}
#else
{
...
#endif
vec2 l9_40=clamp(l9_38,vec2(0.0),vec2(1.0));
float l9_41=l9_40.x*0.33333334;
float l9_42=1.0-l9_40.y;
vec4 l9_43=N75_sourcepartsampleBiLinear(vec2(l9_41,l9_42));
vec4 l9_44=N75_sourcepartsampleBiLinear(vec2(l9_41+0.33333334,l9_42));
vec4 l9_45=N75_sourcepartsampleBiLinear(vec2(l9_41+0.66666669,l9_42));
float l9_46=l9_43.x;
float l9_47=l9_43.y;
float l9_48=l9_44.x;
float l9_49=l9_44.y;
float l9_50=l9_45.x;
float l9_51=max(max(max(max(l9_46,l9_47),l9_48),l9_49),l9_50)-1.0;
vec4 l9_52=vec4(step(length(l9_9-l9_33),0.1),step(length(l9_11-l9_33),0.1),step(length(l9_13-l9_33),0.1),step(length(l9_15-l9_33),0.1))*vec4(exp(5.0*(l9_46-l9_51))/l9_32,exp(5.0*(l9_47-l9_51))/l9_32,exp(5.0*(l9_48-l9_51))/l9_32,exp(5.0*(l9_49-l9_51))/l9_32);
vec2 l9_53=vec2(1.0)/drivingHairMaskSize.xy;
vec2 l9_54=(vec2((l9_1.x+segShiftX)*segRatioX,(l9_1.y+segShiftY)*segRatioY)*drivingHairMaskSize.xy)+vec2(0.5);
vec2 l9_55=fract(l9_54);
vec2 l9_56=(floor(l9_54)/drivingHairMaskSize.xy)-(l9_53/vec2(2.0));
vec4 l9_57=N75_drivinghairTex_sample(l9_56);
vec4 l9_58=N75_drivinghairTex_sample(l9_56+vec2(l9_53.x,0.0));
vec4 l9_59=N75_drivinghairTex_sample(l9_56+vec2(0.0,l9_53.y));
vec4 l9_60=N75_drivinghairTex_sample(l9_56+l9_53);
vec4 l9_61=vec4(l9_55.x);
float l9_62=(step(0.5,l9_39.x)*clamp((((l9_52.x+l9_52.y)+l9_52.w)+l9_52.z)+(step(length(l9_17-l9_33),0.1)*(exp(5.0*(l9_50-l9_51))/l9_32)),0.0,1.0))*(1.0-mix(mix(l9_57,l9_58,l9_61),mix(l9_59,l9_60,l9_61),vec4(l9_55.y)).x);
vec4 l9_63=vec4((l9_37.xyz*l9_62)+(l9_2.xyz*(1.0-l9_62)),1.0);
...
{
l9_67=clamp(dot(l9_63.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_68;
...
{
l9_69=(1.0-dot(l9_63.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_70;
...
{
l9_70=(1.0-clamp(dot(l9_63.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_71;
...
{
l9_71=clamp(dot(l9_63.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_72;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_73=clamp(dot(l9_63.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_74;
...
{
l9_74=dot(l9_63.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_75;
...
#if (sc_FramebufferFetch)
{
vec4 l9_80=sc_readFragData0_Platform();
vec4 l9_81;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_82=l9_80;
l9_82.x=l9_80.x+_sc_framebufferFetchMarker;
l9_81=l9_82;
}
#else
{
...
{
l9_84=1-sc_GetStereoViewIndex();
}
#else
{
l9_84=sc_GetStereoViewIndex();
}
#endif
vec4 l9_85;
#if (sc_ScreenTextureLayout==2)
{
l9_85=sc_SampleView(sc_ScreenTextureDims.xy,l9_83,sc_ScreenTextureLayout,l9_84,0.0,sc_ScreenTextureArrSC);
}
#else
{
l9_85=sc_SampleView(sc_ScreenTextureDims.xy,l9_83,sc_ScreenTextureLayout,l9_84,0.0,sc_ScreenTexture);
}
#endif
l9_79=l9_85;
}
...
{
vec4 l9_87=l9_79;
l9_87.x=l9_79.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_86=l9_87;
}
#else
{
...
#endif
vec3 l9_88=definedBlend(l9_86.xyz,l9_63.xyz);
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_99=sc_ScreenCoordsGlobalToView(l9_0);
...
#if (sc_OITCompositingPass)
{
vec2 l9_112=sc_ScreenCoordsGlobalToView(l9_0);
#if (sc_OITMaxLayers4Plus1)
{
