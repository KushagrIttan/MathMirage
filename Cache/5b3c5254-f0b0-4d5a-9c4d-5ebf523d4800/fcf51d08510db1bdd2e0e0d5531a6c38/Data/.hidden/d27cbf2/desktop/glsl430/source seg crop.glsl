...
//sampler sampler tex1SmpSC 2:30
//sampler sampler tex2SmpSC 2:31
...
//texture texture2D tex1 2:18:2:30
//texture texture2D tex2 2:19:2:31
//texture utexture2D z_hitIdAndBarycentric 2:20:2:32
//texture texture2D z_rayDirections 2:21:2:33
//texture texture2DArray intensityTextureArrSC 2:34:2:22
//texture texture2DArray sc_ScreenTextureArrSC 2:37:2:27
//texture texture2DArray tex1ArrSC 2:38:2:30
//texture texture2DArray tex2ArrSC 2:39:2:31
...
uniform vec4 tex1Dims;
uniform vec4 tex2Dims;
...
uniform vec4 tex1Size;
uniform vec4 tex1View;
uniform mat3 tex1Transform;
uniform vec4 tex1UvMinMax;
uniform vec4 tex1BorderColor;
uniform vec4 tex2Size;
uniform vec4 tex2View;
uniform mat3 tex2Transform;
uniform vec4 tex2UvMinMax;
uniform vec4 tex2BorderColor;
uniform float tex2_opacity;
...
#endif
#ifndef tex1HasSwappedViews
#define tex1HasSwappedViews 0
#elif tex1HasSwappedViews==1
#undef tex1HasSwappedViews
#define tex1HasSwappedViews 1
#endif
#ifndef tex1Layout
#define tex1Layout 0
#endif
#ifndef tex2HasSwappedViews
#define tex2HasSwappedViews 0
#elif tex2HasSwappedViews==1
#undef tex2HasSwappedViews
#define tex2HasSwappedViews 1
#endif
#ifndef tex2Layout
#define tex2Layout 0
#endif
...
#endif
#ifndef SC_USE_UV_TRANSFORM_tex1
#define SC_USE_UV_TRANSFORM_tex1 0
#elif SC_USE_UV_TRANSFORM_tex1==1
#undef SC_USE_UV_TRANSFORM_tex1
#define SC_USE_UV_TRANSFORM_tex1 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_tex1
#define SC_SOFTWARE_WRAP_MODE_U_tex1 -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_tex1
#define SC_SOFTWARE_WRAP_MODE_V_tex1 -1
#endif
#ifndef SC_USE_UV_MIN_MAX_tex1
#define SC_USE_UV_MIN_MAX_tex1 0
#elif SC_USE_UV_MIN_MAX_tex1==1
#undef SC_USE_UV_MIN_MAX_tex1
#define SC_USE_UV_MIN_MAX_tex1 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_tex1
#define SC_USE_CLAMP_TO_BORDER_tex1 0
#elif SC_USE_CLAMP_TO_BORDER_tex1==1
#undef SC_USE_CLAMP_TO_BORDER_tex1
#define SC_USE_CLAMP_TO_BORDER_tex1 1
#endif
#ifndef SC_USE_UV_TRANSFORM_tex2
#define SC_USE_UV_TRANSFORM_tex2 0
#elif SC_USE_UV_TRANSFORM_tex2==1
#undef SC_USE_UV_TRANSFORM_tex2
#define SC_USE_UV_TRANSFORM_tex2 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_tex2
#define SC_SOFTWARE_WRAP_MODE_U_tex2 -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_tex2
#define SC_SOFTWARE_WRAP_MODE_V_tex2 -1
#endif
#ifndef SC_USE_UV_MIN_MAX_tex2
#define SC_USE_UV_MIN_MAX_tex2 0
#elif SC_USE_UV_MIN_MAX_tex2==1
#undef SC_USE_UV_MIN_MAX_tex2
#define SC_USE_UV_MIN_MAX_tex2 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_tex2
#define SC_USE_CLAMP_TO_BORDER_tex2 0
#elif SC_USE_CLAMP_TO_BORDER_tex2==1
#undef SC_USE_CLAMP_TO_BORDER_tex2
#define SC_USE_CLAMP_TO_BORDER_tex2 1
#endif
#ifndef sc_PointLightsCount
#define sc_PointLightsCount 0
#endif
...
uniform sampler2DArray tex1ArrSC;
uniform sampler2D tex2;
uniform sampler2DArray tex2ArrSC;
...
int tex1GetStereoViewIndex()
{
int l9_0;
#if (tex1HasSwappedViews)
{
...
int tex2GetStereoViewIndex()
{
int l9_0;
#if (tex2HasSwappedViews)
{
l9_0=1-sc_GetStereoViewIndex();
}
#else
...
#if (tex1Layout==2)
{
l9_2=sc_SampleTextureBiasOrLevel(tex1Dims.xy,tex1Layout,tex1GetStereoViewIndex(),l9_0,(int(SC_USE_UV_TRANSFORM_tex1)!=0),tex1Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_tex1,SC_SOFTWARE_WRAP_MODE_V_tex1),(int(SC_USE_UV_MIN_MAX_tex1)!=0),tex1UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_tex1)!=0),tex1BorderColor,0.0,tex1ArrSC);
}
#else
{
l9_2=sc_SampleTextureBiasOrLevel(tex1Dims.xy,tex1Layout,tex1GetStereoViewIndex(),l9_0,(int(SC_USE_UV_TRANSFORM_tex1)!=0),tex1Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_tex1,SC_SOFTWARE_WRAP_MODE_V_tex1),(int(SC_USE_UV_MIN_MAX_tex1)!=0),tex1UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_tex1)!=0),tex1BorderColor,0.0,tex1);
}
#endif
vec4 l9_3;
#if (tex2Layout==2)
{
l9_3=sc_SampleTextureBiasOrLevel(tex2Dims.xy,tex2Layout,tex2GetStereoViewIndex(),l9_0,(int(SC_USE_UV_TRANSFORM_tex2)!=0),tex2Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_tex2,SC_SOFTWARE_WRAP_MODE_V_tex2),(int(SC_USE_UV_MIN_MAX_tex2)!=0),tex2UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_tex2)!=0),tex2BorderColor,0.0,tex2ArrSC);
}
#else
{
l9_3=sc_SampleTextureBiasOrLevel(tex2Dims.xy,tex2Layout,tex2GetStereoViewIndex(),l9_0,(int(SC_USE_UV_TRANSFORM_tex2)!=0),tex2Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_tex2,SC_SOFTWARE_WRAP_MODE_V_tex2),(int(SC_USE_UV_MIN_MAX_tex2)!=0),tex2UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_tex2)!=0),tex2BorderColor,0.0,tex2);
}
#endif
vec3 l9_4=mix(l9_2.xyz,vec3(l9_3.x).xyz,vec3(l9_3.x*tex2_opacity));
vec4 l9_5=vec4(l9_4.x,l9_4.y,l9_4.z,vec4(0.0).w);
l9_5.w=l9_2.w;
...
{
l9_10=clamp(l9_2.w*2.0,0.0,1.0);
}
#else
{
float l9_11;
...
{
l9_11=clamp(dot(l9_5.xyz,vec3(l9_2.w)),0.0,1.0);
}
#else
{
float l9_12;
...
{
l9_13=(1.0-dot(l9_5.xyz,vec3(0.33333001)))*l9_2.w;
}
#else
{
float l9_14;
...
{
l9_14=(1.0-clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0))*l9_2.w;
}
#else
{
float l9_15;
...
{
l9_15=clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0)*l9_2.w;
}
#else
{
float l9_16;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_17=clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0)*l9_2.w;
}
#else
{
float l9_18;
...
{
l9_18=dot(l9_5.xyz,vec3(0.33333001))*l9_2.w;
}
#else
{
float l9_19;
...
#else
{
vec2 l9_27=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
int l9_28;
...
#endif
vec3 l9_32=mix(l9_30.xyz,definedBlend(l9_30.xyz,l9_5.xyz).xyz,vec3(l9_2.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_34=vec4(mix(vec3(1.0),l9_5.xyz,vec3(l9_2.w)),l9_2.w);
}
#else
{
vec4 l9_35;
