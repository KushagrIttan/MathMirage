...
//texture texture2D sc_OITAlpha0 2:4:2:21
//texture texture2D sc_OITAlpha1 2:5:2:21
//texture texture2D sc_OITDepthHigh0 2:6:2:21
//texture texture2D sc_OITDepthHigh1 2:7:2:21
//texture texture2D sc_OITDepthLow0 2:8:2:21
//texture texture2D sc_OITDepthLow1 2:9:2:21
//texture texture2D sc_OITFilteredDepthBoundsTexture 2:10:2:21
//texture texture2D sc_OITFrontDepthTexture 2:11:2:21
//texture texture2D sc_ScreenTexture 2:13:2:23
...
#endif
vec4 l9_4=sc_SampleTextureBiasOrLevel(tex2Dims.xy,tex2Layout,l9_3,varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_tex2)!=0),tex2Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_tex2,SC_SOFTWARE_WRAP_MODE_V_tex2),(int(SC_USE_UV_MIN_MAX_tex2)!=0),tex2UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_tex2)!=0),tex2BorderColor,0.0,tex2);
vec4 l9_5=vec4(l9_2,l9_4.x,l9_2,Port_Value4_N007);
...
{
l9_8=clamp(Port_Value4_N007*2.0,0.0,1.0);
}
#else
{
float l9_9;
...
{
l9_9=clamp(dot(l9_5.xyz,vec3(Port_Value4_N007)),0.0,1.0);
}
#else
{
float l9_10;
...
{
l9_11=(1.0-dot(l9_5.xyz,vec3(0.33333001)))*Port_Value4_N007;
}
#else
{
float l9_12;
...
{
l9_12=(1.0-clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0))*Port_Value4_N007;
}
#else
{
float l9_13;
...
{
l9_13=clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0)*Port_Value4_N007;
}
#else
{
float l9_14;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_15=clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0)*Port_Value4_N007;
}
#else
{
float l9_16;
...
{
l9_16=dot(l9_5.xyz,vec3(0.33333001))*Port_Value4_N007;
}
#else
{
float l9_17;
...
#endif
vec3 l9_29=mix(l9_27.xyz,definedBlend(l9_27.xyz,l9_5.xyz).xyz,vec3(Port_Value4_N007));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_31=vec4(mix(vec3(1.0),l9_5.xyz,vec3(Port_Value4_N007)),Port_Value4_N007);
}
#else
{
vec4 l9_32;
...
{
l9_33=clamp(Port_Value4_N007,0.0,1.0);
}
#else
{
l9_33=Port_Value4_N007;
}
#endif
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_41=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
