...
//sampler sampler camTexSmpSC 2:22
//sampler sampler drivingHairMaskSmpSC 2:23
//sampler sampler flowRelativeSmpSC 2:24
//sampler sampler flowSelectionSmpSC 2:25
...
//sampler sampler sourceCropTexSmpSC 2:34
//sampler sampler sourceGarmentMaskSmpSC 2:35
//sampler sampler sourcePartsSmpSC 2:36
//texture texture2D camTex 2:0:2:22
//texture texture2D drivingHairMask 2:1:2:23
//texture texture2D flowRelative 2:2:2:24
//texture texture2D flowSelection 2:3:2:25
...
//texture texture2D sc_ScreenTexture 2:16:2:31
//texture texture2D sourceCropTex 2:19:2:34
//texture texture2D sourceGarmentMask 2:20:2:35
//texture texture2D sourceParts 2:21:2:36
//SG_REFLECTION_END
...
uniform vec4 sourcePartsSize;
uniform vec4 sourcePartsView;
uniform mat3 sourcePartsTransform;
uniform vec4 sourcePartsUvMinMax;
uniform vec4 sourcePartsBorderColor;
...
#endif
#ifndef sourcePartsHasSwappedViews
#define sourcePartsHasSwappedViews 0
#elif sourcePartsHasSwappedViews==1
#undef sourcePartsHasSwappedViews
#define sourcePartsHasSwappedViews 1
#endif
#ifndef sourcePartsLayout
#define sourcePartsLayout 0
#endif
...
#endif
#ifndef SC_USE_UV_TRANSFORM_sourceParts
#define SC_USE_UV_TRANSFORM_sourceParts 0
#elif SC_USE_UV_TRANSFORM_sourceParts==1
#undef SC_USE_UV_TRANSFORM_sourceParts
#define SC_USE_UV_TRANSFORM_sourceParts 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_sourceParts
#define SC_SOFTWARE_WRAP_MODE_U_sourceParts -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_sourceParts
#define SC_SOFTWARE_WRAP_MODE_V_sourceParts -1
#endif
#ifndef SC_USE_UV_MIN_MAX_sourceParts
#define SC_USE_UV_MIN_MAX_sourceParts 0
#elif SC_USE_UV_MIN_MAX_sourceParts==1
#undef SC_USE_UV_MIN_MAX_sourceParts
#define SC_USE_UV_MIN_MAX_sourceParts 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_sourceParts
#define SC_USE_CLAMP_TO_BORDER_sourceParts 0
#elif SC_USE_CLAMP_TO_BORDER_sourceParts==1
#undef SC_USE_CLAMP_TO_BORDER_sourceParts
#define SC_USE_CLAMP_TO_BORDER_sourceParts 1
#endif
#ifndef sc_DepthOnly
...
vec4 N75_flowrelativeTex_sample(vec2 coords)
{
return sc_SampleTextureBiasOrLevel(flowRelativeDims.xy,flowRelativeLayout,flowRelativeGetStereoViewIndex(),coords,(int(SC_USE_UV_TRANSFORM_flowRelative)!=0),flowRelativeTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_flowRelative,SC_SOFTWARE_WRAP_MODE_V_flowRelative),(int(SC_USE_UV_MIN_MAX_flowRelative)!=0),flowRelativeUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_flowRelative)!=0),flowRelativeBorderColor,0.0,flowRelative);
}
vec4 N75_sampleBiLinearRelative(vec2 uv)
{
...
return mix(mix(N75_flowrelativeTex_sample(l9_3),N75_flowrelativeTex_sample(l9_3+vec2(l9_0.x,0.0)),l9_4),mix(N75_flowrelativeTex_sample(l9_3+vec2(0.0,l9_0.y)),N75_flowrelativeTex_sample(l9_3+l9_0),l9_4),vec4(l9_2.y));
}
...
vec4 N75_flowselectionTex_sample(vec2 coords)
{
return sc_SampleTextureBiasOrLevel(flowSelectionDims.xy,flowSelectionLayout,flowSelectionGetStereoViewIndex(),coords,(int(SC_USE_UV_TRANSFORM_flowSelection)!=0),flowSelectionTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_flowSelection,SC_SOFTWARE_WRAP_MODE_V_flowSelection),(int(SC_USE_UV_MIN_MAX_flowSelection)!=0),flowSelectionUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_flowSelection)!=0),flowSelectionBorderColor,0.0,flowSelection);
}
vec4 N75_sampleBiLinearSelection(vec2 uv)
{
...
vec4 l9_4=vec4(l9_2.x);
return mix(mix(N75_flowselectionTex_sample(l9_3),N75_flowselectionTex_sample(l9_3+vec2(l9_0.x,0.0)),l9_4),mix(N75_flowselectionTex_sample(l9_3+vec2(0.0,l9_0.y)),N75_flowselectionTex_sample(l9_3+l9_0),l9_4),vec4(l9_2.y));
}
int sourcePartsGetStereoViewIndex()
{
int l9_0;
#if (sourcePartsHasSwappedViews)
{
l9_0=1-sc_GetStereoViewIndex();
}
#else
...
vec4 N75_sourcepartsTex_sample(vec2 coords)
{
return sc_SampleTextureBiasOrLevel(sourcePartsDims.xy,sourcePartsLayout,sourcePartsGetStereoViewIndex(),coords,(int(SC_USE_UV_TRANSFORM_sourceParts)!=0),sourcePartsTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_sourceParts,SC_SOFTWARE_WRAP_MODE_V_sourceParts),(int(SC_USE_UV_MIN_MAX_sourceParts)!=0),sourcePartsUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_sourceParts)!=0),sourcePartsBorderColor,0.0,sourceParts);
}
vec4 N75_sourcepartsampleBiLinear(vec2 uv)
{
vec2 l9_0=vec2(1.0)/sourcePartsSize.xy;
vec2 l9_1=(uv*sourcePartsSize.xy)+vec2(0.5);
vec2 l9_2=fract(l9_1);
vec2 l9_3=(floor(l9_1)/sourcePartsSize.xy)-(l9_0/vec2(2.0));
vec4 l9_4=vec4(l9_2.x);
return mix(mix(N75_sourcepartsTex_sample(l9_3),N75_sourcepartsTex_sample(l9_3+vec2(l9_0.x,0.0)),l9_4),mix(N75_sourcepartsTex_sample(l9_3+vec2(0.0,l9_0.y)),N75_sourcepartsTex_sample(l9_3+l9_0),l9_4),vec4(l9_2.y));
}
...
#endif
vec4 l9_3=sc_SampleTextureBiasOrLevel(camTexDims.xy,camTexLayout,l9_2,l9_1,(int(SC_USE_UV_TRANSFORM_camTex)!=0),camTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_camTex,SC_SOFTWARE_WRAP_MODE_V_camTex),(int(SC_USE_UV_MIN_MAX_camTex)!=0),camTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_camTex)!=0),camTexBorderColor,0.0,camTex);
vec2 l9_4=(((vec2(flowHalfPx)+(((((l9_1+((cropCenter-(cropSize*0.5))*(-1.0)))*(vec2(1.0)/cropSize))-vec2(0.0))*((1.0-flowHalfPx)-flowHalfPx))/vec2(1.0)))-vec2(0.5))*vec2(1.0,-1.0))+vec2(0.5);
float l9_5=l9_4.x;
float l9_6=l9_5*0.2;
float l9_7=l9_4.y;
float l9_8=l9_5*0.33333334;
vec4 l9_9=N75_sampleBiLinearRelative(vec2(l9_6,l9_7));
vec2 l9_10=l9_9.xy;
vec4 l9_11=N75_sampleBiLinearRelative(vec2(l9_6+0.2,l9_7));
vec2 l9_12=l9_11.xy;
vec4 l9_13=N75_sampleBiLinearRelative(vec2(l9_6+0.40000001,l9_7));
vec2 l9_14=l9_13.xy;
vec4 l9_15=N75_sampleBiLinearRelative(vec2(l9_6+0.60000002,l9_7));
vec2 l9_16=l9_15.xy;
vec4 l9_17=N75_sampleBiLinearRelative(vec2(l9_6+0.80000001,l9_7));
vec2 l9_18=l9_17.xy;
vec4 l9_19=N75_sampleBiLinearSelection(vec2(l9_8,l9_7));
vec4 l9_20=N75_sampleBiLinearSelection(vec2(l9_8+0.33333334,l9_7));
vec4 l9_21=N75_sampleBiLinearSelection(vec2(l9_8+0.66666669,l9_7));
float l9_22=l9_19.x;
float l9_23=l9_19.y;
float l9_24=l9_20.x;
float l9_25=l9_20.y;
float l9_26=l9_21.x;
float l9_27=max(max(max(max(l9_22,l9_23),l9_24),l9_25),l9_26);
float l9_28=exp(l9_22-l9_27);
float l9_29=exp(l9_23-l9_27);
float l9_30=exp(l9_24-l9_27);
float l9_31=exp(l9_25-l9_27);
float l9_32=exp(l9_26-l9_27);
float l9_33=(((l9_28+l9_29)+l9_30)+l9_31)+l9_32;
vec2 l9_34=((((l9_10*(l9_28/l9_33))+(l9_12*(l9_29/l9_33)))+(l9_14*(l9_30/l9_33)))+(l9_16*(l9_31/l9_33)))+(l9_18*(l9_32/l9_33));
vec2 l9_35=((l9_4*2.0)-vec2(1.0))+l9_34;
vec2 l9_36=(((l9_35*vec2(sx,sy))+vec2(dx,dy))+vec2(1.0))/vec2(2.0);
int l9_37;
...
#endif
vec4 l9_38=sc_SampleTextureBiasOrLevel(sourceCropTexDims.xy,sourceCropTexLayout,l9_37,vec2(l9_36.x,1.0-l9_36.y),(int(SC_USE_UV_TRANSFORM_sourceCropTex)!=0),sourceCropTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_sourceCropTex,SC_SOFTWARE_WRAP_MODE_V_sourceCropTex),(int(SC_USE_UV_MIN_MAX_sourceCropTex)!=0),sourceCropTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_sourceCropTex)!=0),sourceCropTexBorderColor,0.0,sourceCropTex);
vec2 l9_39=vec2((0.5*l9_35.x)+0.5,((-0.5)*l9_35.y)+0.5);
int l9_40;
...
#endif
vec4 l9_41=sc_SampleTextureBiasOrLevel(sourceGarmentMaskDims.xy,sourceGarmentMaskLayout,l9_40,l9_39,(int(SC_USE_UV_TRANSFORM_sourceGarmentMask)!=0),sourceGarmentMaskTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_sourceGarmentMask,SC_SOFTWARE_WRAP_MODE_V_sourceGarmentMask),(int(SC_USE_UV_MIN_MAX_sourceGarmentMask)!=0),sourceGarmentMaskUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_sourceGarmentMask)!=0),sourceGarmentMaskBorderColor,0.0,sourceGarmentMask);
vec2 l9_42=clamp(l9_39,vec2(0.0),vec2(1.0));
float l9_43=l9_42.x*0.33333334;
float l9_44=1.0-l9_42.y;
vec4 l9_45=N75_sourcepartsampleBiLinear(vec2(l9_43,l9_44));
vec4 l9_46=N75_sourcepartsampleBiLinear(vec2(l9_43+0.33333334,l9_44));
vec4 l9_47=N75_sourcepartsampleBiLinear(vec2(l9_43+0.66666669,l9_44));
float l9_48=l9_45.x;
float l9_49=l9_45.y;
float l9_50=l9_46.x;
float l9_51=l9_46.y;
float l9_52=l9_47.x;
float l9_53=max(max(max(max(l9_48,l9_49),l9_50),l9_51),l9_52)-1.0;
vec4 l9_54=vec4(step(length(l9_10-l9_34),0.1),step(length(l9_12-l9_34),0.1),step(length(l9_14-l9_34),0.1),step(length(l9_16-l9_34),0.1))*vec4(exp(5.0*(l9_48-l9_53))/l9_33,exp(5.0*(l9_49-l9_53))/l9_33,exp(5.0*(l9_50-l9_53))/l9_33,exp(5.0*(l9_51-l9_53))/l9_33);
vec2 l9_55=vec2(1.0)/drivingHairMaskSize.xy;
vec2 l9_56=(vec2((l9_1.x+segShiftX)*segRatioX,(l9_1.y+segShiftY)*segRatioY)*drivingHairMaskSize.xy)+vec2(0.5);
vec2 l9_57=fract(l9_56);
vec2 l9_58=(floor(l9_56)/drivingHairMaskSize.xy)-(l9_55/vec2(2.0));
vec4 l9_59=N75_drivinghairTex_sample(l9_58);
vec4 l9_60=N75_drivinghairTex_sample(l9_58+vec2(l9_55.x,0.0));
vec4 l9_61=N75_drivinghairTex_sample(l9_58+vec2(0.0,l9_55.y));
vec4 l9_62=N75_drivinghairTex_sample(l9_58+l9_55);
vec4 l9_63=vec4(l9_57.x);
float l9_64=(step(0.5,l9_41.x)*clamp((((l9_54.x+l9_54.y)+l9_54.w)+l9_54.z)+(step(length(l9_18-l9_34),0.1)*(exp(5.0*(l9_52-l9_53))/l9_33)),0.0,1.0))*(1.0-mix(mix(l9_59,l9_60,l9_63),mix(l9_61,l9_62,l9_63),vec4(l9_57.y)).x);
vec4 l9_65=vec4((l9_38.xyz*l9_64)+(l9_3.xyz*(1.0-l9_64)),1.0);
...
{
l9_69=clamp(dot(l9_65.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_70;
...
{
l9_71=(1.0-dot(l9_65.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_72;
...
{
l9_72=(1.0-clamp(dot(l9_65.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_73;
...
{
l9_73=clamp(dot(l9_65.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_74;
#if (sc_BlendMode_Add)
{
l9_74=clamp(dot(l9_65.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_75;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_75=clamp(dot(l9_65.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_76;
...
{
l9_76=dot(l9_65.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_77;
#if (sc_BlendMode_Min)
{
l9_77=1.0-clamp(dot(l9_65.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_78;
#if (sc_BlendMode_Max)
{
l9_78=clamp(dot(l9_65.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_78=1.0;
...
#endif
l9_66=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_65.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_67);
}
#else
{
vec4 l9_79;
...
#if (sc_FramebufferFetch)
{
vec4 l9_82=sc_readFragData0_Platform();
vec4 l9_83;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_84=l9_82;
l9_84.x=l9_82.x+_sc_framebufferFetchMarker;
l9_83=l9_84;
}
#else
{
...
#endif
l9_81=sc_SampleView(sc_ScreenTextureDims.xy,l9_85,sc_ScreenTextureLayout,l9_86,0.0,sc_ScreenTexture);
}
#endif
vec4 l9_87;
...
{
vec4 l9_88=l9_81;
l9_88.x=l9_81.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_87=l9_88;
}
#else
{
...
#endif
vec3 l9_89=definedBlend(l9_87.xyz,l9_65.xyz);
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_100=sc_ScreenCoordsGlobalToView(l9_0);
...
#endif
int l9_101=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_100).xy);
...
#if (sc_OITCompositingPass)
{
vec2 l9_113=sc_ScreenCoordsGlobalToView(l9_0);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_113).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_118==0)
{
l9_121=texture2D(sc_OITAlpha0,l9_113);
l9_120=texture2D(sc_OITDepthLow0,l9_113);
l9_119=texture2D(sc_OITDepthHigh0,l9_113);
}
else
{
l9_121=vec4(0.0);
...
if (l9_118==1)
{
l9_124=texture2D(sc_OITAlpha1,l9_113);
l9_123=texture2D(sc_OITDepthLow1,l9_113);
l9_122=texture2D(sc_OITDepthHigh1,l9_113);
}
else
{
l9_124=l9_121;
...
vec4 l9_139=texture2D(sc_OITFilteredDepthBoundsTexture,l9_113);
