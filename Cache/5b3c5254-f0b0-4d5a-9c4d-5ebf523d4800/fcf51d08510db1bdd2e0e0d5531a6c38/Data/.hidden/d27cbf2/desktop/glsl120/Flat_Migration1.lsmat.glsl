...
#endif
l9_0=baseColor*sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,l9_1,varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex);
}
#else
{
l9_0=baseColor;
...
#endif
l9_2=l9_0.w*sc_SampleTextureBiasOrLevel(opacityTexDims.xy,opacityTexLayout,l9_3,varPackedTex.zw,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex),(int(SC_USE_UV_MIN_MAX_opacityTex)!=0),opacityTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0),opacityTexBorderColor,0.0,opacityTex).x;
}
#else
{
l9_2=l9_0.w;
...
{
l9_8=clamp(dot(l9_4.xyz,vec3(l9_2)),0.0,1.0);
}
#else
{
float l9_9;
...
{
l9_10=(1.0-dot(l9_4.xyz,vec3(0.33333001)))*l9_2;
}
#else
{
float l9_11;
...
{
l9_11=(1.0-clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0))*l9_2;
}
#else
{
float l9_12;
...
{
l9_12=clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0)*l9_2;
}
#else
{
float l9_13;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_14=clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0)*l9_2;
}
#else
{
float l9_15;
...
{
l9_15=dot(l9_4.xyz,vec3(0.33333001))*l9_2;
}
#else
{
float l9_16;
...
#else
{
vec2 l9_24=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
int l9_25;
...
#endif
vec3 l9_28=mix(l9_26.xyz,definedBlend(l9_26.xyz,l9_4.xyz).xyz,vec3(l9_2));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_30=vec4(mix(vec3(1.0),l9_4.xyz,vec3(l9_2)),l9_2);
}
#else
{
vec4 l9_31;
