...
{
return sc_SampleTextureBiasOrLevel(genTexDims.xy,genTexLayout,genTexGetStereoViewIndex(),coords,(int(SC_USE_UV_TRANSFORM_genTex)!=0),genTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_genTex,SC_SOFTWARE_WRAP_MODE_V_genTex),(int(SC_USE_UV_MIN_MAX_genTex)!=0),genTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_genTex)!=0),genTexBorderColor,0.0,genTex);
}
...
vec2 l9_4=((l9_1+((cropCenter-(cropSize*0.5))*(-1.0)))*(vec2(1.0)/cropSize))-vec2(0.0);
vec2 l9_5=(((vec2(flowHalfPx)+((l9_4*((1.0-flowHalfPx)-flowHalfPx))/vec2(1.0)))-vec2(0.5))*vec2(1.0,-1.0))+vec2(0.5);
float l9_6=l9_5.x;
float l9_7=l9_6*0.2;
float l9_8=l9_5.y;
float l9_9=l9_6*0.33333334;
vec4 l9_10=N52_sampleBiLinearRelative(vec2(l9_7,l9_8));
vec4 l9_11=N52_sampleBiLinearRelative(vec2(l9_7+0.2,l9_8));
vec4 l9_12=N52_sampleBiLinearRelative(vec2(l9_7+0.40000001,l9_8));
vec4 l9_13=N52_sampleBiLinearRelative(vec2(l9_7+0.60000002,l9_8));
vec4 l9_14=N52_sampleBiLinearRelative(vec2(l9_7+0.80000001,l9_8));
vec4 l9_15=N52_sampleBiLinearSelection(vec2(l9_9,l9_8));
vec4 l9_16=N52_sampleBiLinearSelection(vec2(l9_9+0.33333334,l9_8));
vec4 l9_17=N52_sampleBiLinearSelection(vec2(l9_9+0.66666669,l9_8));
float l9_18=l9_15.x;
float l9_19=l9_15.y;
float l9_20=l9_16.x;
float l9_21=l9_16.y;
float l9_22=l9_17.x;
float l9_23=max(max(max(max(l9_18,l9_19),l9_20),l9_21),l9_22);
float l9_24=exp(l9_18-l9_23);
float l9_25=exp(l9_19-l9_23);
float l9_26=exp(l9_20-l9_23);
float l9_27=exp(l9_21-l9_23);
float l9_28=exp(l9_22-l9_23);
float l9_29=(((l9_24+l9_25)+l9_26)+l9_27)+l9_28;
vec2 l9_30=((l9_5*2.0)-vec2(1.0))+(((((l9_10.xy*(l9_24/l9_29))+(l9_11.xy*(l9_25/l9_29)))+(l9_12.xy*(l9_26/l9_29)))+(l9_13.xy*(l9_27/l9_29)))+(l9_14.xy*(l9_28/l9_29)));
vec2 l9_31=(((l9_30*vec2(sx,sy))+vec2(dx,dy))+vec2(1.0))/vec2(2.0);
int l9_32;
...
#endif
vec4 l9_33=sc_SampleTextureBiasOrLevel(sourceCropTexDims.xy,sourceCropTexLayout,l9_32,vec2(l9_31.x,1.0-l9_31.y),(int(SC_USE_UV_TRANSFORM_sourceCropTex)!=0),sourceCropTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_sourceCropTex,SC_SOFTWARE_WRAP_MODE_V_sourceCropTex),(int(SC_USE_UV_MIN_MAX_sourceCropTex)!=0),sourceCropTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_sourceCropTex)!=0),sourceCropTexBorderColor,0.0,sourceCropTex);
int l9_34;
...
#endif
vec4 l9_37=sc_SampleTextureBiasOrLevel(shaderMasksTexDims.xy,shaderMasksTexLayout,l9_36,vec2(shaderMaskHalfPx)+((l9_4*((1.0-shaderMaskHalfPx)-shaderMaskHalfPx))/vec2(1.0)),(int(SC_USE_UV_TRANSFORM_shaderMasksTex)!=0),shaderMasksTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_shaderMasksTex,SC_SOFTWARE_WRAP_MODE_V_shaderMasksTex),(int(SC_USE_UV_MIN_MAX_shaderMasksTex)!=0),shaderMasksTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_shaderMasksTex)!=0),shaderMasksTexBorderColor,0.0,shaderMasksTex);
float l9_38=(step(0.80000001,l9_35.x)*l9_37.w)*gridSampAlpha;
vec2 l9_39=vec2(1.0)/genTexSize.xy;
vec2 l9_40=(((((vec2(genHalfPx)+((l9_4*((1.0-genHalfPx)-genHalfPx))/vec2(1.0)))-vec2(0.5))*vec2(1.0,-1.0))+vec2(0.5))*genTexSize.xy)+vec2(0.5);
vec2 l9_41=fract(l9_40);
vec2 l9_42=(floor(l9_40)/genTexSize.xy)-(l9_39/vec2(2.0));
vec4 l9_43=N52_generatedTex_sample(l9_42);
vec4 l9_44=N52_generatedTex_sample(l9_42+vec2(l9_39.x,0.0));
vec4 l9_45=N52_generatedTex_sample(l9_42+vec2(0.0,l9_39.y));
vec4 l9_46=N52_generatedTex_sample(l9_42+l9_39);
vec4 l9_47=vec4(l9_41.x);
vec2 l9_48=vec2(1.0)/drivingHairMaskSize.xy;
vec2 l9_49=(vec2((l9_1.x+segShiftX)*segRatioX,(l9_1.y+segShiftY)*segRatioY)*drivingHairMaskSize.xy)+vec2(0.5);
vec2 l9_50=fract(l9_49);
vec2 l9_51=(floor(l9_49)/drivingHairMaskSize.xy)-(l9_48/vec2(2.0));
vec4 l9_52=N52_drivinghairTex_sample(l9_51);
vec4 l9_53=N52_drivinghairTex_sample(l9_51+vec2(l9_48.x,0.0));
vec4 l9_54=N52_drivinghairTex_sample(l9_51+vec2(0.0,l9_48.y));
vec4 l9_55=N52_drivinghairTex_sample(l9_51+l9_48);
vec4 l9_56=vec4(l9_50.x);
float l9_57=step(0.30000001,l9_37.y)*l9_37.z;
float l9_58=(((1.0-mix(mix(l9_52,l9_53,l9_56),mix(l9_54,l9_55,l9_56),vec4(l9_50.y)).x)*l9_57)*step(0.69999999,l9_57))*genAlpha;
vec4 l9_59=vec4(1.0)/(vec4(1.0)+exp(-vec4(mix(mix(l9_43,l9_44,l9_47),mix(l9_45,l9_46,l9_47),vec4(l9_41.y)).xyz,0.0)));
vec4 l9_60=vec4((vec4(l9_33.xyz,l9_38).xyz*l9_38)+(l9_59.xyz*(1.0-l9_38)),1.0);
bvec4 l9_61=bvec4(float(useShaderGridSample)==1.0);
float l9_62=(1.0*l9_58)+0.0;
vec4 l9_63=vec4((vec4(vec4(l9_61.x ? l9_60.x : l9_59.x,l9_61.y ? l9_60.y : l9_59.y,l9_61.z ? l9_60.z : l9_59.z,l9_61.w ? l9_60.w : l9_59.w).xyz,l9_58).xyz*l9_62)+(l9_3.xyz*(1.0-l9_62)),1.0);
...
#endif
l9_79=sc_SampleView(sc_ScreenTextureDims.xy,l9_83,sc_ScreenTextureLayout,l9_84,0.0,sc_ScreenTexture);
}
#endif
vec4 l9_85;
...
{
vec4 l9_86=l9_79;
l9_86.x=l9_79.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_85=l9_86;
}
#else
{
...
#endif
vec3 l9_87=definedBlend(l9_85.xyz,l9_63.xyz);
...
#endif
int l9_99=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_98).xy);
...
if (l9_116==0)
{
l9_119=texture2D(sc_OITAlpha0,l9_111);
l9_118=texture2D(sc_OITDepthLow0,l9_111);
l9_117=texture2D(sc_OITDepthHigh0,l9_111);
}
else
{
l9_119=vec4(0.0);
...
if (l9_116==1)
{
l9_122=texture2D(sc_OITAlpha1,l9_111);
l9_121=texture2D(sc_OITDepthLow1,l9_111);
l9_120=texture2D(sc_OITDepthHigh1,l9_111);
}
else
{
l9_122=l9_119;
...
vec4 l9_137=texture2D(sc_OITFilteredDepthBoundsTexture,l9_111);
