...
//sampler sampler tex1SmpSC 2:25
//sampler sampler tex2SmpSC 2:26
...
//texture texture2D tex1 2:15:2:25
//texture texture2D tex2 2:16:2:26
//SG_REFLECTION_END
...
#endif
vec4 l9_1=sc_SampleTextureBiasOrLevel(tex1Dims.xy,tex1Layout,l9_0,varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_tex1)!=0),tex1Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_tex1,SC_SOFTWARE_WRAP_MODE_V_tex1),(int(SC_USE_UV_MIN_MAX_tex1)!=0),tex1UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_tex1)!=0),tex1BorderColor,0.0,tex1);
int l9_2;
...
#endif
vec4 l9_3=sc_SampleTextureBiasOrLevel(tex2Dims.xy,tex2Layout,l9_2,varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_tex2)!=0),tex2Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_tex2,SC_SOFTWARE_WRAP_MODE_V_tex2),(int(SC_USE_UV_MIN_MAX_tex2)!=0),tex2UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_tex2)!=0),tex2BorderColor,0.0,tex2);
float l9_4=l9_3.x;
vec3 l9_5=mix(l9_1.xyz,vec3(l9_4).xyz,vec3(l9_4*tex2_opacity));
float l9_6=l9_1.w;
...
{
l9_11=clamp(dot(l9_7.xyz,vec3(l9_6)),0.0,1.0);
}
#else
{
float l9_12;
...
{
l9_13=(1.0-dot(l9_7.xyz,vec3(0.33333001)))*l9_6;
}
#else
{
float l9_14;
...
{
l9_14=(1.0-clamp(dot(l9_7.xyz,vec3(1.0)),0.0,1.0))*l9_6;
}
#else
{
float l9_15;
...
{
l9_15=clamp(dot(l9_7.xyz,vec3(1.0)),0.0,1.0)*l9_6;
}
#else
{
float l9_16;
#if (sc_BlendMode_Add)
{
l9_16=clamp(dot(l9_7.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_17;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_17=clamp(dot(l9_7.xyz,vec3(1.0)),0.0,1.0)*l9_6;
}
#else
{
float l9_18;
...
{
l9_18=dot(l9_7.xyz,vec3(0.33333001))*l9_6;
}
#else
{
float l9_19;
#if (sc_BlendMode_Min)
{
l9_19=1.0-clamp(dot(l9_7.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_20;
#if (sc_BlendMode_Max)
{
l9_20=clamp(dot(l9_7.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_20=1.0;
...
#endif
l9_8=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_7.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_9);
}
#else
{
vec4 l9_21;
...
#endif
l9_23=sc_SampleView(sc_ScreenTextureDims.xy,l9_27,sc_ScreenTextureLayout,l9_28,0.0,sc_ScreenTexture);
}
#endif
vec4 l9_29;
...
{
vec4 l9_30=l9_23;
l9_30.x=l9_23.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_29=l9_30;
}
#else
{
...
#endif
vec3 l9_31=mix(l9_29.xyz,definedBlend(l9_29.xyz,l9_7.xyz).xyz,vec3(l9_6));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_33=vec4(mix(vec3(1.0),l9_7.xyz,vec3(l9_6)),l9_6);
}
#else
{
vec4 l9_34;
...
#endif
l9_34=vec4(l9_7.xyz*l9_35,l9_35);
}
#else
{
l9_34=l9_7;
...
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_43).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_44=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_43).xy);
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_56).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_61==0)
{
l9_64=texture2D(sc_OITAlpha0,l9_56);
l9_63=texture2D(sc_OITDepthLow0,l9_56);
l9_62=texture2D(sc_OITDepthHigh0,l9_56);
}
else
{
l9_64=vec4(0.0);
...
if (l9_61==1)
{
l9_67=texture2D(sc_OITAlpha1,l9_56);
l9_66=texture2D(sc_OITDepthLow1,l9_56);
l9_65=texture2D(sc_OITDepthHigh1,l9_56);
}
else
{
l9_67=l9_64;
...
vec4 l9_82=texture2D(sc_OITFilteredDepthBoundsTexture,l9_56);
vec2 l9_83=l9_82.xy;
int l9_84;
#if (sc_SkinBonesCount>0)
{
